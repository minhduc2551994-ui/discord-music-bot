...
async function searchYouTube(query, limit = 1) {
    return new Promise((resolve, reject) => {
        ...
        const args = isURL
            ? ['--dump-json', '--no-playlist', '--geo-bypass', '--force-ipv4', '--js-runtimes', 'nodejs', query]
            : ['--dump-json', '--default-search', 'ytsearch' + limit, '--geo-bypass', '--force-ipv4', '--js-runtimes', 'nodejs', '--no-playlist', query];
